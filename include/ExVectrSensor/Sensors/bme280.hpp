...
public:
  ...
  static constexpr uint8_t BME280_MEASUREMENTS_REG =
      0xF7; // Measurements register start
  ...
  static constexpr uint8_t BME280_TEMPERATURE_XLSB_REG =
...
protected:
  ...
  float altCov_ = 1; // Default value for altitude covariance in meters
