 ...
 */
class QMC5883 : public VCTR::sensor::Magnetometer {
protected:
  /// IO Bus to use for chip communications.
  HAL::DigitalIO *ioBus_ = nullptr;
  /// If the sensor has been successfully initialised and is in working
  /// condition
  ...
  static constexpr uint8_t QMC5883L_STATUS =
      6; // Addr. 06H, 0 - data ready, 1 - data overflow
